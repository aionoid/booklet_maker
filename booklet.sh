...
$DISPLAY_CMD -t -f banner3-D "1: clean"
rm $OUT
rm -rd $DIR_SECTION
rm -rd $DIR_READY

# PREPAIR
$DISPLAY_CMD -t -f banner3-D "2: prepair"
mkdir $DIR_SECTION
mkdir $DIR_READY

# make a booklet
$DISPLAY_CMD -t -f banner3-D "3: make a booklet"
...
$DISPLAY_CMD -t -f banner3-D "4: split for $DIR_SECTION p sections"
pdfcpu split -q $OUT $DIR_SECTION $(($NSECTIONS * 2))

# collect for each section Front/Back pages
$DISPLAY_CMD -t -f banner3-D "5: export Front/Back pages"
IND=0
